...
@class IpadRightViewController;
@class PoiMedia;

@interface GalleryViewController : UIViewController
@property (weak, nonatomic) IBOutlet UIImageView *imageView;
@property (weak, nonatomic) IpadRightViewController *delegate;
@property (weak, nonatomic) PoiMedia *visibleMedia;

@property (readonly, assign, nonatomic) BOOL videoPlayerVisible;
