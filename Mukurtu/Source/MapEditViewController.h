...
@protocol MapEditViewDelegate <NSObject>
...
@property (weak,nonatomic) UIViewController<MapEditViewDelegate> *delegate;
@property (assign, nonatomic) CLLocationCoordinate2D initialLocationCoordinate;
